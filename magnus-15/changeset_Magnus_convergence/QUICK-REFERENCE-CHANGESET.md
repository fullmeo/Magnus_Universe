# ⚡ QUICK REFERENCE - CHANGESET ADDITION

**Copy-paste this content into `.changeset/magnus-convergence-routing.md`**
...
### STEP 2: Create File
```
Click: "Add files" (top right)
Select: "Create new file"
Path: .changeset/magnus-convergence-routing.md
```

### STEP 3: Paste & Commit
```
Paste: Content from above
Commit message: "docs: add changeset for Magnus 15 PR"
...
Bot will comment within 30 seconds:
```
✅ Changeset detected
✅ @kilo-org/kilocode - minor
✅ Ready for merge
