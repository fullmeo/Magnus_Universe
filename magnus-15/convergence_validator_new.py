...
cat > /home/claude/convergence_validator_new.py << 'EOF'
#!/usr/bin/env python3
"""
MAGNUS 15 - CONVERGENCE VALIDATOR (NEW)
...
class LLMJudge:
    ...
    def evaluate(self, prompt: str, max_tokens: int = 1024) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"⚠️  JSON parse error: {text[:100]}")
...
if __name__ == "__main__":
    ...
    try:
        ...
        traceback.print_exc()
EOF
cat /home/claude/convergence_validator_new.py
Sortie
