// tests/services/convergence/magnus-pattern-engine.test.ts
// Comprehensive tests for MagnusPatternEngine

import { MagnusPatternEngine, MAGNUS_15_PATTERNS } from "../../../src/services/convergence/magnus-pattern-engine"
...
describe("MagnusPatternEngine", () => {
	...
	describe("Pattern Detection", () => {
        ...
        `
			...
			it("should have high magnitude for critical spirals", () => {
				const spiralCode =
					"if (a) { if (b) { if (c) { while (d) { for (e) { /* ... 700 lines */ } } } } }"
	...
	describe("Therapeutic Insights", () => {
      ...
      `
			...
			expect(result.therapeuticInsight).toMatch(/\|/)
		})
